...
```
뭐지? 먹을 수도 없는 복주머니를 왜 가져가려고 한걸까. 이 복주머니에 정말 특별한게 있는 걸까?
```
...
TV화면이 만들어낸 이세계에 대한 환상은 언제나 침묵을 유지하였다. 
그 것이 어디로 향하는지, 그 길이 위험하지는 않은지는 알 수 없었다. 
톰은 강렬하게 이끌리는 본능에 몸을 맡길 뿐, 제리는 어떠한 대답도 들을 수 없었다.
제리의 의심이 확실해지는 순간이었다. 동시에 톰 역시 제리가 자신이 애써 숨기려한 현실을 알아차렸다는 것 쯤은 알 수 있었다. 
톰은 미안한 마음에 고개를 숙였다. 
