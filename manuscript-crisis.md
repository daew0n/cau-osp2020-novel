...
톰과 제리는 병사들이 나빠 보이지는 않아 선처를 바라며 그물 덫에 걸린 채 호소했다.
...
조오커 왕은 흡족스러운듯 미소를 띠며 말했다. 
```
그럼! 그렇게 해야지! 마녀를 물리칠 시간은 단 7일을 주마. 건투를 빈다.
```

딱! 조오커 왕이 손가락을 쳤다. 그러자 빛이 발생하여 톰과 제리는 두 눈을 감았다.

```
악!눈부셔
```

눈을 뜨니 조오커 왕은 온데간데없고 톰과 제리는 어둡고 낯선 곳에 도착해 있었다.
