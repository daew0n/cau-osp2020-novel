...
제리가 몸을 날렸지만 톰을 구출하기엔 제리의 몸이 너무 작았다.
다행히도 돌덩이는 톰의 어깨를 살짝 스치고 떨어졌다.
하지만 하루 종일 너무 많은 일을 겪어 지친 톰에겐 작은 생채기도 큰 고통으로 다가왔다.
```
윽...제리 나 이제 너무 힘들어..
```
제리는 톰을 일으키기 위해 무슨 말을 해야 할지 고민했다.
```
톰, 힘내서 일어나!
너의 집사들이 너를 찾고 있다고..!
```
...
미야미야는 제리를 가볍게 비웃고는 제리와 톰을 향해 마법지팡이를 휘둘렀다.
...
그렇기 때문에 잭은 지금 눈 앞의 인물이 자신에게 저주를 걸었던 미야의 아버지라는 것을 알았다.
...
그래서 지금과 같은 모습을 하고 잭의 앞에 나타나 잭에게 저주를 걸었다.
잭에게 저주를 걸어버린 미야미야지만, 딸이 사랑했던 고양이이기에 그 일을 후회하곤 했었다. 
미야미야는 홀로 생각에 잠겼다.
...
톰도 꼭 묻고 싶은 것이 있어 미야미야에게 질문을 했다.
...
```
그래! 난 천재 쥐 제리니까 나갈 수 있는 방법을 찾아낼거야!
그래도 미야가 어딨는지, 그건 알려줘.. 잭이랑 톰이랑 함께 미야를 만나서 다시 원래 세계로 돌아갈거야!
```

미야미야는 자신의 눈 앞의 톰, 제리, 잭을 바라보았다.
...
이 녀석들... 진심이군..
```
미야미야는 어쩔 수 없다는 표정을 하고선 잭을 결박했던 투명 벽을 풀었다.
그러고선 변장을 풀고 원래의 모습으로 돌아왔다.
...
흰털에 푸른 눈을 가진 고양이, 바로 미야였다.
```
너..너는 미야..?!
```

```
톰, 오랜만이야. 사실 전에도 봤었지만, 이런식으로 다시 볼 줄은 몰랐네.
```
미야는 자신의 원래 모습으로 변신하였다.
그러자 미야의 모습은 톰과 제리가 처음에 만났던 푸른눈의 얼굴이 검은 고양이의 모습이었다.
```
그때 날 앞발로 친 그 고양이..!
```
