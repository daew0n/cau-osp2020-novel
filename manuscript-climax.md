...
```
```
너희들이 그렇게 만난고 싶은 이곳의 대마법사 미야미야가 저들을 모두 저렇게 만들었지! 왜 못 믿겠나? 
```
...
```
```
미야미야를 물리치면 여기 있는 저주받은 내 아이들을 다시 원래대로 되돌릴 있을거야..
```
```
그럼 미야미야를 물리치면 되자나요! 왜 여기서 가만히 숨어있는 거에요! 
```
```
나도 계속해서 미야미야에게 도전해봤지만 이길 수 가 없었어... 내가 할 수 있는 일은 도전하러 오는 동물들에게 돌아가도록 겁을 주는 것뿐이야.. 그니까 너도 돌아가!
```
```
아니에요! 제가 도울게요!
