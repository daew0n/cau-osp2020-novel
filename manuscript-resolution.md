...
```
톰이 긴장한 채로 말했다.
톰에게 간절한 것은 바로 '집사들을 만나는 것'이었다.
톰은 자신을 사랑해줄 집사를 찾아 집을 떠났지만, 몇 번의 고난과 역경을 헤쳐나오면서
자신에게는 그 집사들이 주는 안락함이 절실하게 필요하다는 것을 깨달았다.

톰은 자신의 절실함을 믿고 덤덤하게 차원의 문을 건넜다.
다행히 톰의 절실함이 통한 것인지 차원의 문은 닫히지 않았다.

```
오호, 저 고양이의 진심은 통했나 보구나.
다음에는 누가 건널 것이냐?
```
...
다같이 포근한, 가족같은 분위기란 이런 것인가 하고 느낀 톰이였다.
