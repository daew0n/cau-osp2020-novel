...
처음 톰이 사라진 걸 알았을 때 심장이 발 끝으로 내려 앉는 기분이었다.
심지어 언제 집을 나간지도 모른다니 스스로가 한심하기까지 했다.
...
그런 집사들의 변화가 톰에게는 꽤 만족스러웠다. 가족으로 인정 받는 기분이었다.
...
항상 톰이 봐주기 때문에 제리가 이기곤 했지만 이번엔 제대로 하려는 듯 하다.
