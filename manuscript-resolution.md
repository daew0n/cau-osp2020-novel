...
처음보는 광경에 톰은 입을 다물지 못했다.
블랙홀과 같이 생긴곳에 들어오니 톰은 걱정이 되었다.
과연 이렇게 빨려들어가다 이상한곳을 가는지 모르겠지만 이미 들어오고 난 뒤라 달리 방법이 없었다.
톰은 여태까지 있었던 일이 주마등처럼 지나갔다.
그리고 갑자기 나타난 큰 벽에 부딪치는 것을 느꼈다.
```
...
애초에 톰은 행복을 위해 먼 나정을 떠났었다.
그곳에 가기만 하면 행복을 얻어낼 수 있다고 생각했지만 전혀 그렇지 않았다. 
보상처럼 대가로 주어지는 존재가 아니였던 것이다.
행복은 물질이 아닌 자신만이 자연스레 깨닫게 되는 가치였다.
