...
배고픔이라는 상태를 없애기 위해 애써 이를 무시한 결과였다. 하지만 톰은 그것을 모르는 듯하다.
...
배고픔에 잠시 주인과 보금자리를 떠올렸으나 집을 나온 결정을 후회하지는 않았다.
...
```
괜히 갔다가 이 소고기까지 잃을 수 있으니 참자. 저거 다시 만나면 혼쭐을 내줘야겠어.
```
...
```
```
괜찮아 우리는 그와 아는 사이거든 오랜만에 인사나 할까 해서.
```
```
...
```
```
이세계에 대해 설명하려면 하루종일 해도 모자라지만 최대한 간추려서 얘기해줄게.
이세계는 말이야...
```
톰과 제리는 바퀴벌레 대장의 이야기를 귀기울여 들었다.
하지만 아무리 이해하려고 노력해도 그들로서는 도저히 이해할 수 없는 내용들 뿐이었다.
```
...
톰은 머리가 아파왔다. 
```
도대체 그 세계가 뭐길래 이렇게 머리 아프게 만드는 거지..
```
제리는 곰곰히 생각했고, 잭과 이세계와의 관련성에 대해 더욱 궁금해졌다.
```
흠 잭이 만약 이세계와 관련이 되어있다면 도대체 왜 갔던걸까..?
```
## 절정
