...
노란 눈과 검은색과 회색으로 이루어진 줄무늬고양이인 톰.
...
문을 연 집사의 표정엔 실망감이 가득했다.


```뭐야 너였어? 장난하지 말고 얼른 들어와~```


문을 열어 두고 집에 들어가는 집사. 그런 톰을 제리는 안쓰럽게 바라본다.


톰은 고개를 저으며 슬며시 문을 닫고 제리와 함께 다시 집을 나선다.
